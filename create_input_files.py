...
if __name__ == '__main__':
    ...
    parser.add_argument('--karpathy_json_path', '-p', default='./data/caption_datasets/dataset_flickr30k.json',
    ...
    parser.add_argument('--min_word_freq', '-f', default=1, type=int, help='加入词汇表的词的最小出现频率')
    parser.add_argument('--output_folder', '-o', default='./data/flickr30k_output_1_min', help='预处理后输出文件的目录')
